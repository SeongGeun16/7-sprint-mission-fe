...
const confirmPasswordInput = document.querySelector(".passwordcheck input");
const nicknameInput = document.querySelector(".nickname_text_input");
...
confirmPasswordInput.addEventListener("input", loginButtonState);
